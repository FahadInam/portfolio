    ...
    () => [
      {
        ...
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.KNOWLEDGE_PLATFORM}
          />
        ),
      },
      {
        title: "2nd Mouse Venture",
        value: "second-mouse",
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.SECOND_MOUSE}
          />
        ),
      },
      {
        ...
        content: (
          <StickyScroll
            isDesktop={isDesktop}
            contentItems={WORK_CONTENTS.APIMIO}
          />
        ),
      },
    ],
        ...
        <div className="flex flex-col work-wrapper">
          <div className="flex flex-col">
            ...
            <p className="text-[1.65rem] font-medium md:max-w-lg w-full mt-2 staggered-reveal">
              4+ years of shipping features, leading teams, and scaling products.{" "}
            </p>
          </div>
